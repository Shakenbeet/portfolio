...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a3 = element("a");
    			h33 = element("h3");
    			h33.textContent = "Arcade";
    			attr_dev(h30, "class", "svelte-1nbw01i");
    			add_location(h30, file$6, 20, 20, 295);
    			attr_dev(a0, "href", "#home");
    			add_location(a0, file$6, 20, 4, 279);
    			attr_dev(h31, "class", "svelte-1nbw01i");
    			add_location(h31, file$6, 21, 21, 335);
    			attr_dev(a1, "href", "#about");
    			add_location(a1, file$6, 21, 4, 318);
    			attr_dev(h32, "class", "svelte-1nbw01i");
    			add_location(h32, file$6, 22, 20, 375);
    			attr_dev(a2, "href", "#work");
    			add_location(a2, file$6, 22, 4, 359);
    			attr_dev(h33, "class", "svelte-1nbw01i");
    			add_location(h33, file$6, 23, 22, 416);
    			attr_dev(a3, "href", "#arcade");
    			add_location(a3, file$6, 23, 4, 398);
    			attr_dev(div, "class", "navbar svelte-1nbw01i");
    			add_location(div, file$6, 19, 0, 253);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Copyright © 2022 Shakenbeet";
    			t1 = space();
    			button0 = element("button");
    			button0.textContent = "Github!";
    			t3 = space();
    			button1 = element("button");
    			button1.textContent = "E-Mail";
    			attr_dev(h1, "class", "copyrightText");
    			add_location(h1, file$5, 14, 4, 193);
    			add_location(button0, file$5, 16, 4, 259);
    			add_location(button1, file$5, 17, 4, 289);
    ...
    function create_fragment(ctx) {
    	...
    	shortmodal0 = new ShortModal({
    			props: {
    				msg: "When I started to learn how to program I always wanted to try and get friends and families to learn aswell, however programming proved to difficult for them. August of 2022"
    			},
    			$$inline: true
    		});
    	...
    	shortmodal1 = new ShortModal({
    			props: {
    				msg: "Image Resize replaces images it resizes, permanently deleting the original file. I have fallen victim to my own project's flaws many times, yet I still too lazy to fix it :)"
    			},
    			$$inline: true
    		});
    	...
    	shortmodal2 = new ShortModal({
    			props: {
    				msg: "Nova was written in raw HTML and preformance was terrible. A Desktop version was once available, it was a WPF app that used Cefsharp to connect to the Nova website. Games were difficult to download and play because of how challenging it was to use the Nova client."
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			t8 = space();
    			h12 = element("h1");
    			h12.textContent = "Featured Project";
    			t10 = space();
    			...
    			t12 = space();
    			h13 = element("h1");
    			h13.textContent = "Other Projects";
    			t14 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h12);
    			append_dev(main, t10);
    			mount_component(project0, main, null);
    			append_dev(main, t11);
    			mount_component(shortmodal0, main, null);
    			append_dev(main, t12);
    			append_dev(main, h13);
    			append_dev(main, t14);
    			mount_component(project1, main, null);
    			append_dev(main, t15);
    			mount_component(shortmodal1, main, null);
    			append_dev(main, t16);
    			mount_component(project2, main, null);
    			append_dev(main, t17);
    			mount_component(shortmodal2, main, null);
    			append_dev(main, t18);
